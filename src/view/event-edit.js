  ...
  <form class="event event--edit" action="#" method="post">
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--time">
        ...
        <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${dateFrom.format('DD/MM/YY')} ${dateFrom.format('hh:mm')}">
        &mdash;
        <label class="visually-hidden" for="event-end-time-1">To</label>
        <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dateTo.format('DD/MM/YY')} ${dateTo.format('hh:mm')}">
      </div>
...
export default class TripEventEdit extends AbstractView {
  ...
  setOnEscKeyDownHandler(callback) {
    ...
    this.getElement().querySelector('form').addEventListener('keydown', this._onEscKeyDownHandler);
  }
}
