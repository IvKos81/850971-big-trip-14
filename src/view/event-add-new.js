...
const createEventAddNewFormTemplate = (point) => {
  ...
  // for (let i=0; i<destination.pictures.length; i++) {
  //   const templatePhoto =  `<img class="event__photo" src="${destination.pictures[i].src}" alt="Event photo">`;
  //   tapePhotos.appendChild(templatePhoto);
  // }
      ...
      <section class="event__section  event__section--destination">
        ...
        <div class="event__photos-container">
          <div class="event__photos-tape">
            ...
            <img class="event__photo" src="${destination.pictures[2].src}" alt="Event photo">
            <img class="event__photo" src="${destination.pictures[3].src}" alt="Event photo">
            <img class="event__photo" src="${destination.pictures[4].src}" alt="Event photo">
          </div>
        </div>
      </section>
    </section>
